...
def run_analysis(
    ...
    metadata = {
        ...
        "qof_active": config.qof_lsoa_csv is not None,
        "qof_year": "2024-25",
        "qof_attribution_method": "top-5 nearest GP practices weighted by list_size / distance_km^2",
        "ethnicity_active": config.ethnicity_lsoa_csv is not None,
        "ethnicity_source": "ONS Census 2021 TS021",
        "estate_active": config.eric_geocoded_csv is not None,
        "estate_dataset": "ERIC 2024/25",
        "estate_search_radius_m": config.estate_search_radius_m,
